///Develop an oop program to create a database of stud. info. containg the following info:Name,Roll no.,class,division,Date of birth ,Blood group,Contact address,telephone no,driving no.//
//construct database with suitable member function viz,static member function, friend class/friend function,this pointer,inline code and dynamic memory allocation operators new and delete//
